...
| Компонент | Версия |
|-----------|--------|
| ![Discourse](https://img.shields.io/badge/Discourse-2.7.0+-blue?logo=discourse) | 2.7.0 или выше |
| ![Ruby](https://img.shields.io/badge/Ruby-2.7+-red?logo=ruby) | 2.7+ |
| ![VK ID](https://img.shields.io/badge/VK_ID-App-blue?logo=vk) | Приложение зарегистрировать на [id.vk.ru](https://id.vk.ru/about/business/go) |
| ![VK ID](https://img.shields.io/badge/VK_ID-App-red?logo=vk) | Посмотреть демо на [id.vk.ru](https://id.vk.ru/about/business/demo/) |
---
...
```mermaid
graph LR
    A[Пользователь] -->|Клик Войти| B[VK ID Виджет]
    B -->|Генерация PKCE| C[VK ID Сервер]
    C -->|Код авторизации| D[Discourse Callback]
    D -->|Обмен + Проверка PKCE| E[Access Token]
    E -->|Получение данных| F[Создание/Обновление User]
    F -->|Сессия| A
```
...
|---------|-----------|-----------|
| **Frontend** | ![JavaScript](https://img.shields.io/badge/-JavaScript-yellow?logo=javascript&logoColor=white) VK ID SDK | UI виджета |
| **Backend** | ![Ruby](https://img.shields.io/badge/-Ruby-red?logo=ruby&logoColor=white) Custom Strategy | OAuth 2.1 + PKCE |
| **Auth** | ![OAuth](https://img.shields.io/badge/-OAuth_2.1-green) | Безопасный flow |
| **Data** | ![PostgreSQL](https://img.shields.io/badge/-PostgreSQL-blue?logo=postgresql&logoColor=white) | Хранение пользователей |
...
- **Форум:** [Discourse Meta](https://meta.discourse.org/t/388073/)
